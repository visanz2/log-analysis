...
SOURCES = parser/LogAst.ml parser/LogParser.mly parser/LogLexer.mll parser/MapAst.ml parser/MapParser.mly parser/MapLexer.mll parser/ArgAst.ml parser/ArgParser.mly parser/ArgLexer.mll parser/LogC.ml
...
# For instance:
 LIBS=$(WITHUNIX) $(WITHSTR) $(WITHNUMS)\
